...
public class Jeopardy implements ActionListener {
	...
	public void run() {
		...
		JPanel header = createHeader("Geography");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (buttonPressed == firstButton) {
			askQuestion("Which north American river connects the great lake with the Atlantic Ocean?", "St. Lawrence Seaway", 100);
		} else if (buttonPressed == secondButton) {
			askQuestion("Lebanon has a population most similar to which South American country?" , "Paraguay", 500);
		}
